  ...
  return `  <div id="navbar">
      <div id="logos">
        ...
        <div id="hide">x</div></div>
          ...
          <div id="otherThinks">
            <div>
              <img id="mini_logo" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTQ7J0V6Mhr8P5ledXSACJV2xe10xRkkkmCzg&usqp=CAU" alt="" class="nav_icon">
              <p>Credits</p>
            </div>
            <div>
              <img  id="mini_logo" src="https://www.pinclipart.com/picdir/middle/487-4878262_png-file-svg-earn-points-icon-png-clipart.png" alt=""" alt="">
              <p>Z-POINTS</p>
            </div>
            <div>
           ...
           <span class=line1>.</span>
            ...
            <div>
              <img id="mini_logo" src="https://zoomcar-assets.zoomcar.com/images/original/2b3d93f255a13285a16080174094a95508dee53f.png?1639665849" alt="">
              <p>Profile Verification</p>
            </div>
            <div>
              <img id="mini_logo" src="https://zoomcar-assets.zoomcar.com/images/original/5791eac90f03fbbe399563797b3ef2bb1d341b55.png?1639665875" alt="">
              <p>Change City</p>
            </div>
            <div>
           ...
           <div onclick='window.location.href="./policy and help page/Privacy Policy/Fleet Policy/index.html"'>
            ...
            <div id="logout">
              <img id="mini_logo"  src="https://th.bing.com/th/id/OIP.0mrqOxepIamnbyCNaGxOqAHaHj?pid=ImgDet&rs=1" alt="">
              <p>Logout</p>
            </div>
            <!-- <div> > Credits</div>
            ...
            <div> </div>
            <div> </div>
              <div> Zoomcar Fleet Vehicles Policies</div>
             <div> </div>
